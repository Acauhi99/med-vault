...
- Pre-signed URLs for temporary access, generated by the backend and used for direct client-to-S3 uploads/downloads
...
Client → Backend → S3
  ...
  2. Backend generates pre-signed URL via S3 presigner (limited time, limited scope)
